      ...
      <div id="sidebar-two" class="sidebar w3-bar-block w3-card" style="display:none">
        ...
        <div class="w3-bar-block w3-card">
            <form id="reportForm">
                ...
                <button  class="w3-button w3-block w3-left-align" type="submit" id="ajaxSave" value="save"><i class="fas fa-plus-circle"></i>Save Report</button>
            </form>
        </div>
        <!-- END / Add Report -->
            ...
            function editReport(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $(`#reportBox${data.id}`).
                        replaceWith(`<div id="reportBox${id}"><form id="updateForm${data.id}">@method('PUT')<input id="update${data.id}" name="title" type="text" value="${data.title}"><button onclick="updateForm(event)" data-id="${data.id}" type="submit" value="update"></button></form></div>`);
